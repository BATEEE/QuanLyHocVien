...
{
    public partial class UCFindStudent : UserControl
    {
        private fQuanLyHocVien fMain_72_Thang;
        public UCFindStudent(fQuanLyHocVien fMain_72_Thang)
        {
            InitializeComponent();
        ...
        private void UCFindStudent_Load(object sender, EventArgs e)
        {
